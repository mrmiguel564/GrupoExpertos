...
window.App = {
    ...
    submitForm: function(form) {
        ...
        // Validación especial para el módulo de bodegas
        if (module === 'bodegas') {
            // Validar que se haya seleccionado al menos un encargado
            if (typeof BodegasModule !== 'undefined' && BodegasModule.validateEncargados) {
                if (!BodegasModule.validateEncargados()) {
                    this.showNotification('Debe seleccionar al menos un encargado para la bodega', 'error');
                    return;
                }
            }
        }
